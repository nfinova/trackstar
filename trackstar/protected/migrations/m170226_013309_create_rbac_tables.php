...
class m170226_013309_create_rbac_tables extends CDbMigration
{
	public function up()
	{
        ...
        //create table auth item child table
        ...
        $this->addForeignKey("fk_auth_item_child_parent", "tbl_auth_item_child", "parent",
                "tbl_auth_item", "name", "CASCADE", "CASCADE");
        
        //the tbl_auth_item_child.child is reference to tbl_auth_item.name
        ...
        $this->addForeignKey("fk_auth_assignment_itemname", "tbl_auth_assignment", "itemname",
                "tbl_auth_item", "name", "CASCADE", "CASCADE");
