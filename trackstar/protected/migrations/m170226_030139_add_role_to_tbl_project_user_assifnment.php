...
class m170226_030139_add_role_to_tbl_project_user_assifnment extends CDbMigration
{
	public function up()
	{
        ...
        $this->addForeignKey('fk_project_user_role', 'tbl_project_user_assignment', 'role',
